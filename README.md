...
* [How to make a simple keyboard PCB in KiCAD](https://wiki.ai03.com/books/pcb-design/page/pcb-guide-part-1---preparations) - good for general guidance and set up for making keyboard PCB's in KiCAD - note this is not a key matrix and uses an embedded microcontroller but is very good for general understanding, required schematics/footprints and tips/tricks in KiCAD (the latest version of KiCAD is best to use contrary to the guide)
